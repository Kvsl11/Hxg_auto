...
REM Define o diretório base como a pasta onde este script está
set "BASE_DIR=%~dp0"

REM Define automaticamente o caminho do Python (na subpasta App_py)
set "PYTHON_PATH=%BASE_DIR%App_py\Python313\python.exe"

REM Define o caminho do requirements.txt (na mesma pasta do script)
...
REM Substitui nomes incorretos
